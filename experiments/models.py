...
支持: ResNet-18, VGG-16, DenseNet-121
"""
...
def get_model(name: str, num_classes: int = 10, pretrained_path: Optional[str] = None) -> nn.Module:
    """获取模型实例
    ...
    model = MODEL_REGISTRY[name](num_classes=num_classes)
